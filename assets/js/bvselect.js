        ...
        item.addEventListener("click", (e) => {
          ...
          if (
            ...
            if (selected_option.attributes.multiple) {
              ...
              // Updates main div
              let displayValue = item.textContent.substring(2, 4);
              ...
              document.getElementById("ul_" + randomID).style.visibility =
                "hidden";
    ...
    this.CriarDivBase = function () {
      ...
      if (!selected_option.attributes.multiple) {
        ...
        if (FoundSelectedOP == 1) {
          first_option_text = selected_option.options[
